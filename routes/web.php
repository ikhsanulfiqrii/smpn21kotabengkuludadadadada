...
Route::get('/','Frontend\IndexController@index');
    ...
    ///// MENU \\\\\
        ...
        Route::get('struktur',[App\Http\Controllers\Frontend\IndexController::class,'struktur'])->name('struktur.sekolah');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('/')->middleware('role:Admin')->group( function (){
        ...
        Route::resources([
            ...
            'backend-struktur'  => Backend\Website\StrukturController::class,
            //// PROGRAM STUDI \\\\
