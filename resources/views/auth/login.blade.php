...
<head>
    ...
    <title>Login Page - SMPN 21 KOTA BENGKULU</title>
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="/">
                            ...
                            <h2 class="brand-text text-primary ml-1">SMPN 21 KOTA BENGKULU</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                @endif
                                <h2 class="card-title font-weight-bold mb-1">Welcome to SMPN 21 KOTA BENGKULU</h2>
                                ...
                                <form class="auth-login-form mt-2" action="{{route('login')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label for="login-password">Password</label><a href=""></a>
                                        </div>
