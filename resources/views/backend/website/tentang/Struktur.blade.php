                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @if ($struktur == NULL)
                                        <form action=" {{route('backend-struktur.store')}} " method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                            ...
                                            <a href="{{route('backend-struktur.index')}}" class="btn btn-warning">Batal</a>
                                        </form>
                                    @else
                                        <form action=" {{route('backend-struktur.update', $struktur->id)}} " method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
