                ...
                <ul class="menu-content">
                    ...
                    <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Second Level">Tentang</span></a>
                        <ul class="menu-content">
                            ...
                            <li class="nav-item {{ (request()->is('backend-struktur')) ? 'active' : '' }}">
                                <a class="d-flex align-items-center" href="{{route('backend-struktur.index')}}"><span class="menu-item text-truncate" data-i18n="Third Level">Struktur</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
