                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="header-top-left">
                        <div class="logo-area">
                            ...
                            @else
                            <img class="img-responsive" src="{{asset('storage/images/logo/' .$footer->logo)}}" alt="logo" height="160" width="103">
                            @endif
                        </div>
                    </div>
                </div>
                        ...
                        <ul>
                            ...
                            <li><a href="#">Tentang Kami</a>
                                <ul>
                                    ...
                                    <li><a href=" {{route('struktur.sekolah')}} ">Struktur Sekolah</a></li>
                                </ul>
                            </li>
